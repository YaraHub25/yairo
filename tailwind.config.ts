	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				"cyber-surface-elevated":
					"hsl(var(--cyber-surface-elevated))",
			},
			backgroundImage: {
			...
			keyframes: {
				...
				"glow-pulse": {
					"0%, 100%": {
						boxShadow:
							"0 0 5px hsl(var(--neon-turquoise) / 0.5)",
					},
					"50%": {
						boxShadow:
							"0 0 20px hsl(var(--neon-turquoise) / 0.8), 0 0 30px hsl(var(--neon-turquoise) / 0.4)",
					},
				},
				"slide-up": {
					"0%": {
