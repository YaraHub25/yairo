...
const LiveDemoSection = () => {
  ...
  // Correct time labels for each bar (matching your chartData length)
  const hourLabels = [
    "9am",
    "10am",
    "11am",
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="relative">
            <div className="relative flex items-center">
              ...
              />
              <Button variant="hero" className="absolute right-2 h-10">
                Search
              </Button>
            </div>
          </div>
                          ...
                          <div className="relative">
                            <div
                              className={`${getBarColor(
                                value
                              )} rounded-t-md w-8 transition-all duration-300 hover:brightness-110 relative`}
                              style={{
                                height: `${(value / 22) * 140}px`,
                              }}
                            />
